...
namespace Yarn.Unity.Editor
{
    ...
    public class YarnProjectImporterEditor : ScriptedImporterEditor
    {
        ...
        public static SerializedProperty CurrentProjectDefaultLanguageProperty;
        ...
        public override void OnInspectorGUI()
        {
            ...
            // Determines whether or not we draw the GUI for the public Yarn
            // localisation system.
    ...
    /// a property.
    /// </remarks>
    public class HideWhenPropertyValueEqualsContextAttribute : PropertyAttribute
    {
        /// <summary>
    ...
    public class HideWhenValueEqualsContextAttributeEditor : PropertyDrawer
    {
        /// <summary>
        ...
        public override void OnGUI(Rect position, SerializedProperty property, GUIContent label)
        {
            ...
            // Get the public method EditorGUI.DefaultPropertyField,
