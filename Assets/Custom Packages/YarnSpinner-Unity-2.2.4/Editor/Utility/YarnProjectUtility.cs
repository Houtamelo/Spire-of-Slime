...
namespace Yarn.Unity.Editor
{
    ...
    public static class YarnProjectUtility
    {
        ...
        public static string CreateYarnProject(YarnImporter initialSourceAsset)
        {
        ...
        public static void AssignScriptToProject(TextAsset newSourceScript, YarnImporter scriptImporter, YarnProjectImporter projectImporter) {
        ...
        public static void UpdateLocalizationCSVs(YarnProjectImporter yarnProjectImporter)
        {
        ...
        public static void UpdateAssetAddresses(YarnProjectImporter importer)
        {
#if USE_ADDRESSABLES
        ...
        public static Dictionary<string, string> FindAssetPathsForLineIDs(IEnumerable<string> lineIDs, string assetsFolderPath)
        {
        ...
        public static bool WriteStringsFile(string destination, YarnProjectImporter yarnProjectImporter)
        {
        ...
        /// <exception cref="IOException">Thrown when an error is
        /// encountered when writing the data to disk.</exception>
        public static bool WriteMetadataFile(string destination, YarnProjectImporter yarnProjectImporter)
        {
        ...
        public static void ConvertImplicitVariableDeclarationsToExplicit(YarnProjectImporter yarnProjectImporter) {
