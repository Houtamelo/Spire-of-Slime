...
namespace Yarn.Unity
{
    ...
    public class Localization : ScriptableObject
    {
        ...
        public static string GetAddressForLine(string lineID, string language) {
        ...
        [System.Serializable]
        class AssetDictionary : SerializedDictionary<string, Object> { }
        ...
        /// should be used.
        /// </remarks>
        public bool UsesAddressableAssets { get => _usesAddressableAssets; set => _usesAddressableAssets = value; }
        ...
        public T GetLocalizedObject<T>(string key) where T : Object
        {
        ...
        public void SetLocalizedObject<T>(string key, T value) where T : Object => _assetTable.Add(key, value);

        public bool ContainsLocalizedObject<T>(string key) where T : Object => _assetTable.ContainsKey(key) && _assetTable[key] is T;

        public void AddLocalizedObject<T>(string key, T value) where T : Object => _assetTable.Add(key, value);

        public void AddLocalizedObjects<T>(IEnumerable<KeyValuePair<string, T>> objects) where T : Object
        {
