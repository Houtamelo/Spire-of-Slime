...
namespace Yarn
{
    ...
    public static class TypeUtil
    {
        ...
        public static Delegate GetMethod<TResult>(Func<Value, Value, TResult> f) => f;

        public static Delegate GetMethod<T>(Func<Value, T> f) => f;

        public static Delegate GetMethod<T>(Func<T> f) => f;
        ...
        public static IType FindImplementingTypeForMethod(IType type, string methodName)
        {
            if (type is null)
            {
        ...
        public static string GetCanonicalNameForMethod(IType implementingType, string methodName)
        {
        ...
        public static void GetNamesFromCanonicalName(string canonicalName, out string typeName, out string methodName)
        {
            if (string.IsNullOrEmpty(canonicalName))
            {
                throw new ArgumentException($"'{nameof(canonicalName)}' cannot be null or empty.", nameof(canonicalName));
            }
            ...
            {
                throw new ArgumentException($"Invalid canonical method name {canonicalName}");
            }
        ...
        public static bool IsSubType(IType parentType, IType subType)
        {
