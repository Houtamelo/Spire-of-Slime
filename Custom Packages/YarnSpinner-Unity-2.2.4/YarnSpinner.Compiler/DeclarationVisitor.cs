namespace Yarn.Compiler
{
    ...
    /// </summary>
    public class DeclarationVisitor : YarnSpinnerParserBaseVisitor<IType>
    {
        ...
        public override IType VisitFile_hashtag(YarnSpinnerParser.File_hashtagContext context)
        {
        ...
        public override IType VisitDeclare_statement(YarnSpinnerParser.Declare_statementContext context)
        {
            ...
            Declaration existingExplicitDeclaration = Declarations.Where(d => d.IsImplicit == false).FirstOrDefault(d => d.Name == variableName);
            ...
            ConstantValueVisitor constantValueVisitor = new ConstantValueVisitor(context, sourceFileName, Types, ref this.diagnostics);
            Value value = constantValueVisitor.Visit(context.value());
