namespace Yarn.Compiler
{
    ...
    public class JumpGraphListener : YarnSpinnerParserBaseListener
    {
        ...
        public override void ExitNode([NotNull] YarnSpinnerParser.NodeContext context)
        {
            ...
            {
                GraphingNode node = new GraphingNode
                                    {
        ...
        public override void ExitHeader([NotNull] YarnSpinnerParser.HeaderContext context) 
        {
            ...
            else if (context.header_key.Text.Equals("position"))
            {
                ...
                string positionalString = context.header_value.Text;
                string[] split = positionalString.Split(',');
        ...
        {
            string destination = context.destination.Text;
        ...
        {
            string destination = context.expression().GetText();
            jumps.Add(destination);
        }
    }
}
