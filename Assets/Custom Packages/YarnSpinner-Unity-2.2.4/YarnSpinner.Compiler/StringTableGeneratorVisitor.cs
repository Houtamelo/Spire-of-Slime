namespace Yarn.Compiler
{
    ...
    /// entries.
    /// </summary>
    public class StringTableGeneratorVisitor : YarnSpinnerParserBaseVisitor<int>
    {
        ...
        public override int VisitNode(YarnSpinnerParser.NodeContext context)
        {
            ...
            if (string.IsNullOrEmpty(currentNodeName) == false && tags.Contains("rawText"))
            {
                ...
                string lineID = Compiler.GetLineIDForNodeName(currentNodeName);
        ...
        public override int VisitLine_statement([NotNull] YarnSpinnerParser.Line_statementContext context)
        {
            ...
            YarnSpinnerParser.HashtagContext lineIDTag = Compiler.GetLineIDTag(hashtags);
            string lineID = lineIDTag?.text.Text ?? null;

            string[] hashtagText = GetHashtagTexts(hashtags);

            GenerateFormattedText(context.line_formatted_text().children, out string composedString, out int expressionCount);
        ...
        public static string[] GetHashtagTexts(YarnSpinnerParser.HashtagContext[] hashtags)
        {
            // Add hashtag
            List<string> hashtagText = new List<string>();
            foreach (YarnSpinnerParser.HashtagContext tag in hashtags)
            {
