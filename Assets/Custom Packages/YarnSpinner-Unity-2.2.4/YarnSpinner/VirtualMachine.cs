...
namespace Yarn
{
    ...
    public class VirtualMachine
    {
        ...
        public VirtualMachine(Dialogue d)
        {
            dialogue = d;
            state = new State();
        }
        ...
        public int FindInstructionPointForLabel(string labelName)
        {
                ...
                case OpCode.CallFunc:
                    {
                        ...
                        {
                            string paramatersMessage = "";
                            foreach (object obj in parametersToUse)
                            {
                                if (obj is Value value)
                                    paramatersMessage += value.Type + value.InternalValue.ToString() + ", ";
                                else
                                    paramatersMessage += obj.GetType() + obj.ToString() + ", ";
                            }

                            Debug.LogError(function.Method.Name + "\nTarget: " + function.Target + "\nInvocation List: " + function.GetInvocationList().ElementsToString() + "\n" + function + "\nParameters: " + paramatersMessage);
                ...
                case OpCode.PushVariable:
                    {
                        ...
                        if (didLoadValue)
                        {
                            Type loadedObjectType = loadedObject.GetType();
