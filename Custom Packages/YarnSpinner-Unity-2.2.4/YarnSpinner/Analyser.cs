...
namespace Yarn.Analysis
{
    ...
    public class Context {
        ...
        public IEnumerable<Type> defaultAnalyserClasses {
            get {
        ...
        public void AddProgramToAnalysis(Program program) {
    ...
    public class UnusedVariableChecker : CompiledProgramAnalyser {
