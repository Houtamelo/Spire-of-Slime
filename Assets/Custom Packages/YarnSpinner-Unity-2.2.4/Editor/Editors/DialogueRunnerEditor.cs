        ...
        public override void OnInspectorGUI()
        {
            ...
            if (lineProviderProperty.objectReferenceValue == null)
            {
                ...
                if (yarnProject != null && yarnProject.localizationType == LocalizationType.Unity) {
                    ...
                    #else
                    EditorGUILayout.HelpBox($"This project uses Unity Localization, but Unity Localization is not installed. Please install it, or change this Yarn Project to use Yarn Spinner's public localisation system.", MessageType.Error);
                    #endif
