...
{
    public abstract record EventsHandlerRecord : ModuleRecord
    {
        public abstract IEventsHandler Deserialize(CharacterStateMachine owner);
    }
