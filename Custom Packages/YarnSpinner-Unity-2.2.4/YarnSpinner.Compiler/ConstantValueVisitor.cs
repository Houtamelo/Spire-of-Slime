namespace Yarn.Compiler
{
    ...
    /// </summary>
    public class ConstantValueVisitor : YarnSpinnerParserBaseVisitor<Value>
    {
        ...
        {
            if (float.TryParse(context.GetText(), System.Globalization.NumberStyles.Float, System.Globalization.CultureInfo.InvariantCulture, out float result))
            {
