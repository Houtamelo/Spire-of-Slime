...
namespace Core.Combat.Scripts.Behaviour.Modules
{
    ...
    {
        /// <summary> Use this as base for pow with duration as the exponent, e.g: Mathf.Pow(PenaltyForOvertime, duration + 1) </summary>
        ...
        public static float ProcessSummonResistance(int resistance) => 1 + (resistance / 100f);
