...
{
    public class VariableDeclarationUpgrader : ILanguageUpgrader
    {
        
        
        public UpgradeResult Upgrade(UpgradeJob upgradeJob)
        {
            OrderedSet<TypeBinding> potentialTypeBindings = new OrderedSet<TypeBinding>();
            OrderedSet<string> allSeenVariables = new OrderedSet<string>();
            ...
            foreach (CompilationJob.File file in upgradeJob.Files)
            {
                ...
                VariableTypeBindingVisitor declarationVisitor = new VariableTypeBindingVisitor(potentialTypeBindings, allSeenVariables);
            ...
            foreach (CompilationJob.File file in upgradeJob.Files)
            {
                ...
                VariableTypeBindingVisitor declarationVisitorWithReplacements = new VariableTypeBindingVisitor(potentialTypeBindings, allSeenVariables, replacements);
            ...
            Dictionary<string, IType> allBindings = unifiedVariableBindings.ToDictionary(b => b.VariableName, b => b.Type);
            ...
            if (allSeenVariables.Count() > 0)
            {
                ...
                StringBuilder declarationsNodeStringBuilder = new StringBuilder();

                // declarationsNodeStringBuilder.AppendLine
                string[] preambleLines = new[]
                                         {
                ...
                // default value.
                Dictionary<IType, string> typesToStrings = new Dictionary<IType, string>
                                                           {
                ...
                foreach (string variableName in allSeenVariables)
                {
                    IType type;
                    ...
                    bool typeIsDefined = type != BuiltinTypes.Undefined;
                ...
                string outputDirectory = System.IO.Path.GetDirectoryName(upgradeJob.Files.First().FileName);
                string outputFileName = System.IO.Path.Combine(outputDirectory, "Program.yarnproject");

                UpgradeResult.OutputFile declarationsOutputFile = new UpgradeResult.OutputFile(outputFileName, declarationsNodeStringBuilder.ToString());
        ...
        /// thrown.
        /// </summary>
        private class VariableTypeBindingVisitor : YarnSpinnerV1ParserBaseVisitor<IType>
        {
            ...
            protected override IType DefaultResult => BuiltinTypes.Undefined;

            public override IType VisitValueString(YarnSpinnerV1Parser.ValueStringContext context)
            {
                return BuiltinTypes.String;
            }

            public override IType VisitValueTrue(YarnSpinnerV1Parser.ValueTrueContext context)
            {
                return BuiltinTypes.Boolean;
            }

            public override IType VisitValueFalse(YarnSpinnerV1Parser.ValueFalseContext context)
            {
                return BuiltinTypes.Boolean;
            }

            public override IType VisitValueNumber(YarnSpinnerV1Parser.ValueNumberContext context)
            {
                return BuiltinTypes.Number;
            }

            public override IType VisitValueVar(YarnSpinnerV1Parser.ValueVarContext context)
            {
                return this.VisitVariable(context.variable());
            }

            public override IType VisitVariable(YarnSpinnerV1Parser.VariableContext context)
            {
                ...
                IEnumerable<TypeBinding> bindings = this.potentialTypeBindings.Where(b => b.VariableName == name);

                return bindings.Count() != 1 ? BuiltinTypes.Undefined : bindings.First().Type;
            }

            public override IType VisitValueNull(YarnSpinnerV1Parser.ValueNullContext context)
            {
            ...
            public override IType VisitValueFunc(YarnSpinnerV1Parser.ValueFuncContext context)
            {
                ...
                YarnSpinnerV1Parser.ExpressionContext[] suppliedParameters = context.function().expression();

                for (int i = 0; i < suppliedParameters.Length; i++)
                {
                    YarnSpinnerV1Parser.ExpressionContext suppliedParameter = suppliedParameters[i];
            ...
            public override IType VisitExpValue(YarnSpinnerV1Parser.ExpValueContext context)
            {
                // Value expressions have the type of their inner value
                return Visit(context.value());
            }

            public override IType VisitExpParens(YarnSpinnerV1Parser.ExpParensContext context)
            {
                // Parens expressions have the type of their inner expression
                return Visit(context.expression());
            }

            public override IType VisitExpAndOrXor(YarnSpinnerV1Parser.ExpAndOrXorContext context)
            {
                return CheckOperation(context, context.expression(), context.op.Text, BuiltinTypes.Boolean);
            }

            private IType CheckOperation(ParserRuleContext context, ParserRuleContext[] terms, string operationType, params IType[] permittedTypes)
            {

                List<IType> types = new List<IType>();

                // Get all defined types from our terms
                Dictionary<ParserRuleContext, IType> termsToTypes = terms.ToDictionary(t => t, t => this.Visit(t));

                Dictionary<ParserRuleContext, IType>.ValueCollection termTypes = termsToTypes.Values;
                ...
                IEnumerable<YarnSpinnerV1Parser.ExpressionContext> nonVariableTerms = terms.OfType<YarnSpinnerV1Parser.ExpressionContext>()
                                                                                           .Where(c => c.GetChild<YarnSpinnerV1Parser.ValueVarContext>(0) == null);
                
                foreach (YarnSpinnerV1Parser.ExpressionContext term in nonVariableTerms) {
                ...
                // their names
                IEnumerable<string> variableNames = terms
                ...
                IEnumerable<IType> variableTypes = this.potentialTypeBindings
                ...
                IEnumerable<IType> potentialExpressionTypes = termTypes
            ...
            public override IType VisitIf_clause(YarnSpinnerV1Parser.If_clauseContext context)
            {
            ...
            public override IType VisitElse_if_clause(YarnSpinnerV1Parser.Else_if_clauseContext context)
            {
                YarnSpinnerV1Parser.ExpressionContext expressionContext = context.expression();
                this.CheckAndRewriteIfClause(context, expressionContext);
            ...
            private void CheckAndRewriteIfClause(ParserRuleContext context, YarnSpinnerV1Parser.ExpressionContext expressionContext)
            {
                ...
                YarnSpinnerV1Parser.ExpressionContext[] expressions = new[] { expressionContext };

                IType type = this.CheckOperation(context, expressions, "if statement", BuiltinTypes.Boolean, BuiltinTypes.Number);
                ...
                if (this.GenerateReplacements && type == BuiltinTypes.Number)
                {
                    ...
                    bool isSimpleExpression = expressionContext is YarnSpinnerV1Parser.ExpValueContext;
                    ...
                    Interval interval = new Interval(expressionContext.Start.StartIndex, expressionContext.Stop.StopIndex);
            ...
            public override IType VisitExpAddSub(YarnSpinnerV1Parser.ExpAddSubContext context)
            {

                YarnSpinnerV1Parser.ExpressionContext[] expressions = context.expression();
            ...
            public override IType VisitExpMultDivMod(YarnSpinnerV1Parser.ExpMultDivModContext context)
            {
                YarnSpinnerV1Parser.ExpressionContext[] expressions = context.expression();
            ...
            public override IType VisitExpPlusMinusEquals(YarnSpinnerV1Parser.ExpPlusMinusEqualsContext context)
            {
            ...
            public override IType VisitExpMultDivModEquals(YarnSpinnerV1Parser.ExpMultDivModEqualsContext context)
            {
                ParserRuleContext[] terms = { context.variable(), context.expression() };
            ...
            public override IType VisitExpComparison(YarnSpinnerV1Parser.ExpComparisonContext context)
            {
            ...
            public override IType VisitExpEquality(YarnSpinnerV1Parser.ExpEqualityContext context)
            {
                ParserRuleContext[] terms = context.expression();
            ...
            public override IType VisitExpNegative(YarnSpinnerV1Parser.ExpNegativeContext context)
            {
            ...
            public override IType VisitExpNot(YarnSpinnerV1Parser.ExpNotContext context)
            {
                ParserRuleContext[] terms = new[] { context.expression() };
            ...
            public override IType VisitSetVariableToValue([NotNull] YarnSpinnerV1Parser.SetVariableToValueContext context)
            {
                ...
                IType valueType = this.Visit(context.expression());
